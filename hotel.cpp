...
int Hotel::CheckOut(int roomno)
{
    ...
    Database.setDatabaseName("C:/Users/admin/Desktop/cpp/Hotel_Management_in_QT/hotelmanagement.db");
    if(QFile::exists("C:/Users/admin/Desktop/cpp/Hotel_Management_in_QT/hotelmanagement.db"))
